...
class  Inventario extends CI_Model {
    ...
    public function obtenerDatosInventario(){
        $this->db->select('i.id_inventory, u.user_name AS nombre_usuario, c.category_name AS nombre_categoria, i.descripcion AS descripcion_articulo, i.nombre AS nombre_articulo, i.cost, i.price, i.status_inventory, i.id_user');
